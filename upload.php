...
<body>
    <?php 
        ...
        echo"
            ...
            <div class='card'>
                ...
                <form method='post' enctype= 'multipart/form-data'>
                    <label id='update_profile'><i class='fa fa-circle-o' aria-hidden='true'></i>Select Profile</label>
        ...
        if(!isset($_POST['update'])){
            ...
            $image_top = $_FILES['u_image']['top_name'];
            ...
            if($u_image == ''){
                ...
                move_uploaded_file($image_top, "images/$u_image.$random_number");
